    ...
    <main className="page-container section-padding animate-in fade-in duration-700">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col items-center gap-4 text-center h-fit">
          ...
          <Badge className="bg-cyan-50 text-cyan-700 border-0 uppercase tracking-widest font-bold px-3 py-1 mt-1">
            {user.role || 'PATIENT'}
          </Badge>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-4 pt-4 border-t border-gray-100">
              ...
              <Button 
                ...
                className="gradient-primary text-white rounded-xl px-8 py-2.5 w-full sm:w-auto h-auto font-bold shadow-md shadow-cyan-100 hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none"
              >
                {isUpdating ? (
                  <>
